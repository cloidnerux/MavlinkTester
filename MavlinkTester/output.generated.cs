...
namespace MavLink
{
	...
	public class Msg_set_cam_shutter : MavlinkMessage
    {
        ...
        public override int Serialize(byte[] bytes, ref int offset)
            {
                return MavLinkSerializer.Serialize_SET_CAM_SHUTTER(this, bytes, ref offset);
            }        
	}

	public class Msg_image_triggered : MavlinkMessage
    {
        ...
        public override int Serialize(byte[] bytes, ref int offset)
            {
                return MavLinkSerializer.Serialize_IMAGE_TRIGGERED(this, bytes, ref offset);
            }        
	}

	public class Msg_image_trigger_control : MavlinkMessage
    {
        ...
        public override int Serialize(byte[] bytes, ref int offset)
            {
                return MavLinkSerializer.Serialize_IMAGE_TRIGGER_CONTROL(this, bytes, ref offset);
            }        
	}

	public class Msg_image_available : MavlinkMessage
    {
        ...
        public override int Serialize(byte[] bytes, ref int offset)
            {
                return MavLinkSerializer.Serialize_IMAGE_AVAILABLE(this, bytes, ref offset);
            }        
	}
	...
	/// </summary>
	public class Msg_set_position_control_offset : MavlinkMessage
    {
        ...
        public override int Serialize(byte[] bytes, ref int offset)
            {
                return MavLinkSerializer.Serialize_SET_POSITION_CONTROL_OFFSET(this, bytes, ref offset);
            }        
	}

	public class Msg_position_control_setpoint : MavlinkMessage
    {
        ...
        public override int Serialize(byte[] bytes, ref int offset)
            {
                return MavLinkSerializer.Serialize_POSITION_CONTROL_SETPOINT(this, bytes, ref offset);
            }        
	}

	public class Msg_marker : MavlinkMessage
    {
		public UInt16 id;
        ...
        public override int Serialize(byte[] bytes, ref int offset)
            {
                return MavLinkSerializer.Serialize_MARKER(this, bytes, ref offset);
            }        
	}

	public class Msg_raw_aux : MavlinkMessage
    {
        ...
        public override int Serialize(byte[] bytes, ref int offset)
            {
                return MavLinkSerializer.Serialize_RAW_AUX(this, bytes, ref offset);
            }        
	}

	public class Msg_watchdog_heartbeat : MavlinkMessage
    {
        ...
        public override int Serialize(byte[] bytes, ref int offset)
            {
                return MavLinkSerializer.Serialize_WATCHDOG_HEARTBEAT(this, bytes, ref offset);
            }        
	}

	public class Msg_watchdog_process_info : MavlinkMessage
    {
		...
		/// Process name
		/// </summary>
		public byte[] name; // Array size 100

		/// <summary>
		/// Process arguments
		/// </summary>
		public byte[] arguments; // Array size 147
        ...
        public override int Serialize(byte[] bytes, ref int offset)
            {
                return MavLinkSerializer.Serialize_WATCHDOG_PROCESS_INFO(this, bytes, ref offset);
            }        
	}

	public class Msg_watchdog_process_status : MavlinkMessage
    {
        ...
        public override int Serialize(byte[] bytes, ref int offset)
            {
                return MavLinkSerializer.Serialize_WATCHDOG_PROCESS_STATUS(this, bytes, ref offset);
            }        
	}

	public class Msg_watchdog_command : MavlinkMessage
    {
        ...
        public override int Serialize(byte[] bytes, ref int offset)
            {
                return MavLinkSerializer.Serialize_WATCHDOG_COMMAND(this, bytes, ref offset);
            }        
	}

	public class Msg_pattern_detected : MavlinkMessage
    {
		...
		/// Pattern file name
		/// </summary>
		public byte[] file; // Array size 100
        ...
        public override int Serialize(byte[] bytes, ref int offset)
            {
                return MavLinkSerializer.Serialize_PATTERN_DETECTED(this, bytes, ref offset);
            }        
	}
	...
	///            
	/// </summary>
	public class Msg_point_of_interest : MavlinkMessage
    {
		...
		/// POI name
		/// </summary>
		public byte[] name; // Array size 26

        public override int Serialize(byte[] bytes, ref int offset)
            {
                return MavLinkSerializer.Serialize_POINT_OF_INTEREST(this, bytes, ref offset);
            }        
	}
	...
	///            
	/// </summary>
	public class Msg_point_of_interest_connection : MavlinkMessage
    {
        ...
        public override int Serialize(byte[] bytes, ref int offset)
            {
                return MavLinkSerializer.Serialize_POINT_OF_INTEREST_CONNECTION(this, bytes, ref offset);
            }        
	}

	public class Msg_brief_feature : MavlinkMessage
    {
		...
		public byte[] descriptor; // Array size 32
        ...
        public override int Serialize(byte[] bytes, ref int offset)
            {
                return MavLinkSerializer.Serialize_BRIEF_FEATURE(this, bytes, ref offset);
            }        
	}

	public class Msg_attitude_control : MavlinkMessage
    {
        ...
        public override int Serialize(byte[] bytes, ref int offset)
            {
                return MavLinkSerializer.Serialize_ATTITUDE_CONTROL(this, bytes, ref offset);
            }        
	}

	public class Msg_detection_stats : MavlinkMessage
    {
        ...
        public override int Serialize(byte[] bytes, ref int offset)
            {
                return MavLinkSerializer.Serialize_DETECTION_STATS(this, bytes, ref offset);
            }        
	}

	public class Msg_onboard_health : MavlinkMessage
    {
        ...
        public override int Serialize(byte[] bytes, ref int offset)
            {
                return MavLinkSerializer.Serialize_ONBOARD_HEALTH(this, bytes, ref offset);
            }        
	}
