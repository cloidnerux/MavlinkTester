...
namespace MavLink
{
    ...
    public static class MavLinkSerializer
    {
        ...
        {
			{151, new MavPacketInfo(Deserialize_SET_CAM_SHUTTER, 108)},
			{152, new MavPacketInfo(Deserialize_IMAGE_TRIGGERED, 86)},
			{153, new MavPacketInfo(Deserialize_IMAGE_TRIGGER_CONTROL, 95)},
			{154, new MavPacketInfo(Deserialize_IMAGE_AVAILABLE, 224)},
			{160, new MavPacketInfo(Deserialize_SET_POSITION_CONTROL_OFFSET, 22)},
			{170, new MavPacketInfo(Deserialize_POSITION_CONTROL_SETPOINT, 28)},
			{171, new MavPacketInfo(Deserialize_MARKER, 249)},
			{172, new MavPacketInfo(Deserialize_RAW_AUX, 182)},
			{180, new MavPacketInfo(Deserialize_WATCHDOG_HEARTBEAT, 153)},
			{181, new MavPacketInfo(Deserialize_WATCHDOG_PROCESS_INFO, 16)},
			{182, new MavPacketInfo(Deserialize_WATCHDOG_PROCESS_STATUS, 29)},
			{183, new MavPacketInfo(Deserialize_WATCHDOG_COMMAND, 162)},
			{190, new MavPacketInfo(Deserialize_PATTERN_DETECTED, 90)},
			{191, new MavPacketInfo(Deserialize_POINT_OF_INTEREST, 95)},
			{192, new MavPacketInfo(Deserialize_POINT_OF_INTEREST_CONNECTION, 36)},
			{195, new MavPacketInfo(Deserialize_BRIEF_FEATURE, 88)},
			{200, new MavPacketInfo(Deserialize_ATTITUDE_CONTROL, 254)},
			{205, new MavPacketInfo(Deserialize_DETECTION_STATS, 87)},
			{206, new MavPacketInfo(Deserialize_ONBOARD_HEALTH, 19)},
		...
		internal static MavlinkMessage Deserialize_SET_CAM_SHUTTER(byte[] bytes, int offset)
		{
			return new Msg_set_cam_shutter
			{
				gain = bitconverter.ToSingle(bytes, offset + 0),
				interval = bitconverter.ToUInt16(bytes, offset + 4),
				exposure = bitconverter.ToUInt16(bytes, offset + 6),
				cam_no = bytes[offset + 8],
				cam_mode = bytes[offset + 9],
				trigger_pin = bytes[offset + 10],
			};
		}

		internal static MavlinkMessage Deserialize_IMAGE_TRIGGERED(byte[] bytes, int offset)
		{
			return new Msg_image_triggered
			{
				timestamp = bitconverter.ToUInt64(bytes, offset + 0),
				seq = bitconverter.ToUInt32(bytes, offset + 8),
				roll = bitconverter.ToSingle(bytes, offset + 12),
				pitch = bitconverter.ToSingle(bytes, offset + 16),
				yaw = bitconverter.ToSingle(bytes, offset + 20),
				local_z = bitconverter.ToSingle(bytes, offset + 24),
				lat = bitconverter.ToSingle(bytes, offset + 28),
				lon = bitconverter.ToSingle(bytes, offset + 32),
				alt = bitconverter.ToSingle(bytes, offset + 36),
				ground_x = bitconverter.ToSingle(bytes, offset + 40),
				ground_y = bitconverter.ToSingle(bytes, offset + 44),
				ground_z = bitconverter.ToSingle(bytes, offset + 48),
			};
		}

		internal static MavlinkMessage Deserialize_IMAGE_TRIGGER_CONTROL(byte[] bytes, int offset)
		{
			return new Msg_image_trigger_control
			{
				enable = bytes[offset + 0],
			};
		}

		internal static MavlinkMessage Deserialize_IMAGE_AVAILABLE(byte[] bytes, int offset)
		{
			return new Msg_image_available
			{
				cam_id = bitconverter.ToUInt64(bytes, offset + 0),
				timestamp = bitconverter.ToUInt64(bytes, offset + 8),
				valid_until = bitconverter.ToUInt64(bytes, offset + 16),
				img_seq = bitconverter.ToUInt32(bytes, offset + 24),
				img_buf_index = bitconverter.ToUInt32(bytes, offset + 28),
				key = bitconverter.ToUInt32(bytes, offset + 32),
				exposure = bitconverter.ToUInt32(bytes, offset + 36),
				gain = bitconverter.ToSingle(bytes, offset + 40),
				roll = bitconverter.ToSingle(bytes, offset + 44),
				pitch = bitconverter.ToSingle(bytes, offset + 48),
				yaw = bitconverter.ToSingle(bytes, offset + 52),
				local_z = bitconverter.ToSingle(bytes, offset + 56),
				lat = bitconverter.ToSingle(bytes, offset + 60),
				lon = bitconverter.ToSingle(bytes, offset + 64),
				alt = bitconverter.ToSingle(bytes, offset + 68),
				ground_x = bitconverter.ToSingle(bytes, offset + 72),
				ground_y = bitconverter.ToSingle(bytes, offset + 76),
				ground_z = bitconverter.ToSingle(bytes, offset + 80),
				width = bitconverter.ToUInt16(bytes, offset + 84),
				height = bitconverter.ToUInt16(bytes, offset + 86),
				depth = bitconverter.ToUInt16(bytes, offset + 88),
				cam_no = bytes[offset + 90],
				channels = bytes[offset + 91],
			};
		}

		internal static MavlinkMessage Deserialize_SET_POSITION_CONTROL_OFFSET(byte[] bytes, int offset)
		{
			return new Msg_set_position_control_offset
			{
		...
		internal static MavlinkMessage Deserialize_POSITION_CONTROL_SETPOINT(byte[] bytes, int offset)
		{
			return new Msg_position_control_setpoint
			{
				x = bitconverter.ToSingle(bytes, offset + 0),
				y = bitconverter.ToSingle(bytes, offset + 4),
				z = bitconverter.ToSingle(bytes, offset + 8),
				yaw = bitconverter.ToSingle(bytes, offset + 12),
				id = bitconverter.ToUInt16(bytes, offset + 16),
			};
		}

		internal static MavlinkMessage Deserialize_MARKER(byte[] bytes, int offset)
		{
			return new Msg_marker
			{
				x = bitconverter.ToSingle(bytes, offset + 0),
				y = bitconverter.ToSingle(bytes, offset + 4),
				z = bitconverter.ToSingle(bytes, offset + 8),
				...
				pitch = bitconverter.ToSingle(bytes, offset + 16),
				yaw = bitconverter.ToSingle(bytes, offset + 20),
				id = bitconverter.ToUInt16(bytes, offset + 24),
			};
		}

		internal static MavlinkMessage Deserialize_RAW_AUX(byte[] bytes, int offset)
		{
			return new Msg_raw_aux
			{
				baro = bitconverter.ToInt32(bytes, offset + 0),
				adc1 = bitconverter.ToUInt16(bytes, offset + 4),
				adc2 = bitconverter.ToUInt16(bytes, offset + 6),
				adc3 = bitconverter.ToUInt16(bytes, offset + 8),
				adc4 = bitconverter.ToUInt16(bytes, offset + 10),
				vbat = bitconverter.ToUInt16(bytes, offset + 12),
				temp = bitconverter.ToInt16(bytes, offset + 14),
			};
		}

		internal static MavlinkMessage Deserialize_WATCHDOG_HEARTBEAT(byte[] bytes, int offset)
		{
			return new Msg_watchdog_heartbeat
			{
				watchdog_id = bitconverter.ToUInt16(bytes, offset + 0),
				process_count = bitconverter.ToUInt16(bytes, offset + 2),
			};
		}

		internal static MavlinkMessage Deserialize_WATCHDOG_PROCESS_INFO(byte[] bytes, int offset)
		{
			return new Msg_watchdog_process_info
			{
				timeout = bitconverter.ToInt32(bytes, offset + 0),
				watchdog_id = bitconverter.ToUInt16(bytes, offset + 4),
				process_id = bitconverter.ToUInt16(bytes, offset + 6),
				name =  ByteArrayUtil.ToChar(bytes, offset + 8, 100),
				arguments =  ByteArrayUtil.ToChar(bytes, offset + 108, 147),
			};
		}

		internal static MavlinkMessage Deserialize_WATCHDOG_PROCESS_STATUS(byte[] bytes, int offset)
		{
			return new Msg_watchdog_process_status
			{
				pid = bitconverter.ToInt32(bytes, offset + 0),
				watchdog_id = bitconverter.ToUInt16(bytes, offset + 4),
				process_id = bitconverter.ToUInt16(bytes, offset + 6),
				crashes = bitconverter.ToUInt16(bytes, offset + 8),
				state = bytes[offset + 10],
				muted = bytes[offset + 11],
			};
		}

		internal static MavlinkMessage Deserialize_WATCHDOG_COMMAND(byte[] bytes, int offset)
		{
			return new Msg_watchdog_command
			{
				watchdog_id = bitconverter.ToUInt16(bytes, offset + 0),
				process_id = bitconverter.ToUInt16(bytes, offset + 2),
				target_system_id = bytes[offset + 4],
				command_id = bytes[offset + 5],
			};
		}

		internal static MavlinkMessage Deserialize_PATTERN_DETECTED(byte[] bytes, int offset)
		{
			return new Msg_pattern_detected
			{
				confidence = bitconverter.ToSingle(bytes, offset + 0),
				type = bytes[offset + 4],
				file =  ByteArrayUtil.ToChar(bytes, offset + 5, 100),
				detected = bytes[offset + 105],
			};
		}

		internal static MavlinkMessage Deserialize_POINT_OF_INTEREST(byte[] bytes, int offset)
		{
			return new Msg_point_of_interest
			{
				x = bitconverter.ToSingle(bytes, offset + 0),
				y = bitconverter.ToSingle(bytes, offset + 4),
				z = bitconverter.ToSingle(bytes, offset + 8),
				timeout = bitconverter.ToUInt16(bytes, offset + 12),
				type = bytes[offset + 14],
				color = bytes[offset + 15],
				coordinate_system = bytes[offset + 16],
				name =  ByteArrayUtil.ToChar(bytes, offset + 17, 26),
			};
		}

		internal static MavlinkMessage Deserialize_POINT_OF_INTEREST_CONNECTION(byte[] bytes, int offset)
		{
			return new Msg_point_of_interest_connection
			{
				xp1 = bitconverter.ToSingle(bytes, offset + 0),
				yp1 = bitconverter.ToSingle(bytes, offset + 4),
				zp1 = bitconverter.ToSingle(bytes, offset + 8),
				xp2 = bitconverter.ToSingle(bytes, offset + 12),
				yp2 = bitconverter.ToSingle(bytes, offset + 16),
				zp2 = bitconverter.ToSingle(bytes, offset + 20),
				timeout = bitconverter.ToUInt16(bytes, offset + 24),
				type = bytes[offset + 26],
				color = bytes[offset + 27],
				coordinate_system = bytes[offset + 28],
				name =  ByteArrayUtil.ToChar(bytes, offset + 29, 26),
			};
		}

		internal static MavlinkMessage Deserialize_BRIEF_FEATURE(byte[] bytes, int offset)
		{
			return new Msg_brief_feature
			{
				x = bitconverter.ToSingle(bytes, offset + 0),
				y = bitconverter.ToSingle(bytes, offset + 4),
				z = bitconverter.ToSingle(bytes, offset + 8),
				response = bitconverter.ToSingle(bytes, offset + 12),
				size = bitconverter.ToUInt16(bytes, offset + 16),
				orientation = bitconverter.ToUInt16(bytes, offset + 18),
				orientation_assignment = bytes[offset + 20],
				descriptor =  ByteArrayUtil.ToUInt8(bytes, offset + 21, 32),
			};
		}

		internal static MavlinkMessage Deserialize_ATTITUDE_CONTROL(byte[] bytes, int offset)
		{
			return new Msg_attitude_control
			{
				...
				target = bytes[offset + 16],
				roll_manual = bytes[offset + 17],
				pitch_manual = bytes[offset + 18],
				yaw_manual = bytes[offset + 19],
				thrust_manual = bytes[offset + 20],
			};
		}

		internal static MavlinkMessage Deserialize_DETECTION_STATS(byte[] bytes, int offset)
		{
			return new Msg_detection_stats
			{
				detections = bitconverter.ToUInt32(bytes, offset + 0),
				cluster_iters = bitconverter.ToUInt32(bytes, offset + 4),
				best_score = bitconverter.ToSingle(bytes, offset + 8),
				best_lat = bitconverter.ToInt32(bytes, offset + 12),
				best_lon = bitconverter.ToInt32(bytes, offset + 16),
				best_alt = bitconverter.ToInt32(bytes, offset + 20),
				best_detection_id = bitconverter.ToUInt32(bytes, offset + 24),
				best_cluster_id = bitconverter.ToUInt32(bytes, offset + 28),
				best_cluster_iter_id = bitconverter.ToUInt32(bytes, offset + 32),
				images_done = bitconverter.ToUInt32(bytes, offset + 36),
				images_todo = bitconverter.ToUInt32(bytes, offset + 40),
				fps = bitconverter.ToSingle(bytes, offset + 44),
			};
		}

		internal static MavlinkMessage Deserialize_ONBOARD_HEALTH(byte[] bytes, int offset)
		{
			return new Msg_onboard_health
			{
				uptime = bitconverter.ToUInt32(bytes, offset + 0),
				ram_total = bitconverter.ToSingle(bytes, offset + 4),
				swap_total = bitconverter.ToSingle(bytes, offset + 8),
				disk_total = bitconverter.ToSingle(bytes, offset + 12),
				temp = bitconverter.ToSingle(bytes, offset + 16),
				voltage = bitconverter.ToSingle(bytes, offset + 20),
				network_load_in = bitconverter.ToSingle(bytes, offset + 24),
				network_load_out = bitconverter.ToSingle(bytes, offset + 28),
				cpu_freq = bitconverter.ToUInt16(bytes, offset + 32),
				cpu_load = bytes[offset + 34],
				ram_usage = bytes[offset + 35],
				swap_usage = bytes[offset + 36],
				disk_health = bitconverter.ToInt8(bytes, offset + 37),
				disk_usage = bytes[offset + 38],
			};
		}
		...
		internal static int Serialize_SET_CAM_SHUTTER(this Msg_set_cam_shutter msg, byte[] bytes, ref int offset)
		{
			bitconverter.GetBytes(msg.gain, bytes, offset + 0);
			bitconverter.GetBytes(msg.interval, bytes, offset + 4);
			bitconverter.GetBytes(msg.exposure, bytes, offset + 6);
			bytes[offset + 8] = msg.cam_no;
			bytes[offset + 9] = msg.cam_mode;
			bytes[offset + 10] = msg.trigger_pin;
			offset += 11;
			return 151;
		}

		internal static int Serialize_IMAGE_TRIGGERED(this Msg_image_triggered msg, byte[] bytes, ref int offset)
		{
			...
			bitconverter.GetBytes(msg.pitch, bytes, offset + 16);
			bitconverter.GetBytes(msg.yaw, bytes, offset + 20);
			bitconverter.GetBytes(msg.local_z, bytes, offset + 24);
			bitconverter.GetBytes(msg.lat, bytes, offset + 28);
			bitconverter.GetBytes(msg.lon, bytes, offset + 32);
			bitconverter.GetBytes(msg.alt, bytes, offset + 36);
			bitconverter.GetBytes(msg.ground_x, bytes, offset + 40);
			bitconverter.GetBytes(msg.ground_y, bytes, offset + 44);
			bitconverter.GetBytes(msg.ground_z, bytes, offset + 48);
			offset += 52;
			return 152;
		}

		internal static int Serialize_IMAGE_TRIGGER_CONTROL(this Msg_image_trigger_control msg, byte[] bytes, ref int offset)
		{
			bytes[offset + 0] = msg.enable;
			offset += 1;
			return 153;
		}

		internal static int Serialize_IMAGE_AVAILABLE(this Msg_image_available msg, byte[] bytes, ref int offset)
		{
			bitconverter.GetBytes(msg.cam_id, bytes, offset + 0);
			bitconverter.GetBytes(msg.timestamp, bytes, offset + 8);
			bitconverter.GetBytes(msg.valid_until, bytes, offset + 16);
			bitconverter.GetBytes(msg.img_seq, bytes, offset + 24);
			bitconverter.GetBytes(msg.img_buf_index, bytes, offset + 28);
			bitconverter.GetBytes(msg.key, bytes, offset + 32);
			bitconverter.GetBytes(msg.exposure, bytes, offset + 36);
			bitconverter.GetBytes(msg.gain, bytes, offset + 40);
			bitconverter.GetBytes(msg.roll, bytes, offset + 44);
			bitconverter.GetBytes(msg.pitch, bytes, offset + 48);
			bitconverter.GetBytes(msg.yaw, bytes, offset + 52);
			bitconverter.GetBytes(msg.local_z, bytes, offset + 56);
			bitconverter.GetBytes(msg.lat, bytes, offset + 60);
			bitconverter.GetBytes(msg.lon, bytes, offset + 64);
			bitconverter.GetBytes(msg.alt, bytes, offset + 68);
			bitconverter.GetBytes(msg.ground_x, bytes, offset + 72);
			bitconverter.GetBytes(msg.ground_y, bytes, offset + 76);
			bitconverter.GetBytes(msg.ground_z, bytes, offset + 80);
			bitconverter.GetBytes(msg.width, bytes, offset + 84);
			bitconverter.GetBytes(msg.height, bytes, offset + 86);
			bitconverter.GetBytes(msg.depth, bytes, offset + 88);
			bytes[offset + 90] = msg.cam_no;
			bytes[offset + 91] = msg.channels;
			offset += 92;
			return 154;
		}

		internal static int Serialize_SET_POSITION_CONTROL_OFFSET(this Msg_set_position_control_offset msg, byte[] bytes, ref int offset)
		{
		...
		internal static int Serialize_POSITION_CONTROL_SETPOINT(this Msg_position_control_setpoint msg, byte[] bytes, ref int offset)
		{
			bitconverter.GetBytes(msg.x, bytes, offset + 0);
			bitconverter.GetBytes(msg.y, bytes, offset + 4);
			bitconverter.GetBytes(msg.z, bytes, offset + 8);
			bitconverter.GetBytes(msg.yaw, bytes, offset + 12);
			bitconverter.GetBytes(msg.id, bytes, offset + 16);
			offset += 18;
			return 170;
		}

		internal static int Serialize_MARKER(this Msg_marker msg, byte[] bytes, ref int offset)
		{
			bitconverter.GetBytes(msg.x, bytes, offset + 0);
			bitconverter.GetBytes(msg.y, bytes, offset + 4);
			bitconverter.GetBytes(msg.z, bytes, offset + 8);
			...
			bitconverter.GetBytes(msg.pitch, bytes, offset + 16);
			bitconverter.GetBytes(msg.yaw, bytes, offset + 20);
			bitconverter.GetBytes(msg.id, bytes, offset + 24);
			offset += 26;
			return 171;
		}

		internal static int Serialize_RAW_AUX(this Msg_raw_aux msg, byte[] bytes, ref int offset)
		{
			bitconverter.GetBytes(msg.baro, bytes, offset + 0);
			bitconverter.GetBytes(msg.adc1, bytes, offset + 4);
			bitconverter.GetBytes(msg.adc2, bytes, offset + 6);
			bitconverter.GetBytes(msg.adc3, bytes, offset + 8);
			bitconverter.GetBytes(msg.adc4, bytes, offset + 10);
			bitconverter.GetBytes(msg.vbat, bytes, offset + 12);
			bitconverter.GetBytes(msg.temp, bytes, offset + 14);
			offset += 16;
			return 172;
		}

		internal static int Serialize_WATCHDOG_HEARTBEAT(this Msg_watchdog_heartbeat msg, byte[] bytes, ref int offset)
		{
			bitconverter.GetBytes(msg.watchdog_id, bytes, offset + 0);
			bitconverter.GetBytes(msg.process_count, bytes, offset + 2);
			offset += 4;
			return 180;
		}

		internal static int Serialize_WATCHDOG_PROCESS_INFO(this Msg_watchdog_process_info msg, byte[] bytes, ref int offset)
		{
			bitconverter.GetBytes(msg.timeout, bytes, offset + 0);
			bitconverter.GetBytes(msg.watchdog_id, bytes, offset + 4);
			bitconverter.GetBytes(msg.process_id, bytes, offset + 6);
			ByteArrayUtil.ToByteArray(msg.name, bytes, offset + 8, 100);
			ByteArrayUtil.ToByteArray(msg.arguments, bytes, offset + 108, 147);
			offset += 255;
			return 181;
		}

		internal static int Serialize_WATCHDOG_PROCESS_STATUS(this Msg_watchdog_process_status msg, byte[] bytes, ref int offset)
		{
			bitconverter.GetBytes(msg.pid, bytes, offset + 0);
			bitconverter.GetBytes(msg.watchdog_id, bytes, offset + 4);
			bitconverter.GetBytes(msg.process_id, bytes, offset + 6);
			bitconverter.GetBytes(msg.crashes, bytes, offset + 8);
			bytes[offset + 10] = msg.state;
			bytes[offset + 11] = msg.muted;
			offset += 12;
			return 182;
		}

		internal static int Serialize_WATCHDOG_COMMAND(this Msg_watchdog_command msg, byte[] bytes, ref int offset)
		{
			bitconverter.GetBytes(msg.watchdog_id, bytes, offset + 0);
			bitconverter.GetBytes(msg.process_id, bytes, offset + 2);
			bytes[offset + 4] = msg.target_system_id;
			bytes[offset + 5] = msg.command_id;
			offset += 6;
			return 183;
		}

		internal static int Serialize_PATTERN_DETECTED(this Msg_pattern_detected msg, byte[] bytes, ref int offset)
		{
			bitconverter.GetBytes(msg.confidence, bytes, offset + 0);
			bytes[offset + 4] = msg.type;
			ByteArrayUtil.ToByteArray(msg.file, bytes, offset + 5, 100);
			bytes[offset + 105] = msg.detected;
			offset += 106;
			return 190;
		}

		internal static int Serialize_POINT_OF_INTEREST(this Msg_point_of_interest msg, byte[] bytes, ref int offset)
		{
			bitconverter.GetBytes(msg.x, bytes, offset + 0);
			bitconverter.GetBytes(msg.y, bytes, offset + 4);
			bitconverter.GetBytes(msg.z, bytes, offset + 8);
			bitconverter.GetBytes(msg.timeout, bytes, offset + 12);
			bytes[offset + 14] = msg.type;
			bytes[offset + 15] = msg.color;
			bytes[offset + 16] = msg.coordinate_system;
			ByteArrayUtil.ToByteArray(msg.name, bytes, offset + 17, 26);
			offset += 43;
			return 191;
		}

		internal static int Serialize_POINT_OF_INTEREST_CONNECTION(this Msg_point_of_interest_connection msg, byte[] bytes, ref int offset)
		{
			bitconverter.GetBytes(msg.xp1, bytes, offset + 0);
			bitconverter.GetBytes(msg.yp1, bytes, offset + 4);
			bitconverter.GetBytes(msg.zp1, bytes, offset + 8);
			bitconverter.GetBytes(msg.xp2, bytes, offset + 12);
			bitconverter.GetBytes(msg.yp2, bytes, offset + 16);
			bitconverter.GetBytes(msg.zp2, bytes, offset + 20);
			bitconverter.GetBytes(msg.timeout, bytes, offset + 24);
			bytes[offset + 26] = msg.type;
			bytes[offset + 27] = msg.color;
			bytes[offset + 28] = msg.coordinate_system;
			ByteArrayUtil.ToByteArray(msg.name, bytes, offset + 29, 26);
			offset += 55;
			return 192;
		}

		internal static int Serialize_BRIEF_FEATURE(this Msg_brief_feature msg, byte[] bytes, ref int offset)
		{
			bitconverter.GetBytes(msg.x, bytes, offset + 0);
			bitconverter.GetBytes(msg.y, bytes, offset + 4);
			bitconverter.GetBytes(msg.z, bytes, offset + 8);
			bitconverter.GetBytes(msg.response, bytes, offset + 12);
			bitconverter.GetBytes(msg.size, bytes, offset + 16);
			bitconverter.GetBytes(msg.orientation, bytes, offset + 18);
			bytes[offset + 20] = msg.orientation_assignment;
			ByteArrayUtil.ToByteArray(msg.descriptor, bytes, offset + 21, 32);
			offset += 53;
			return 195;
		}

		internal static int Serialize_ATTITUDE_CONTROL(this Msg_attitude_control msg, byte[] bytes, ref int offset)
		{
			...
			bytes[offset + 16] = msg.target;
			bytes[offset + 17] = msg.roll_manual;
			bytes[offset + 18] = msg.pitch_manual;
			bytes[offset + 19] = msg.yaw_manual;
			bytes[offset + 20] = msg.thrust_manual;
			offset += 21;
			return 200;
		}

		internal static int Serialize_DETECTION_STATS(this Msg_detection_stats msg, byte[] bytes, ref int offset)
		{
			bitconverter.GetBytes(msg.detections, bytes, offset + 0);
			bitconverter.GetBytes(msg.cluster_iters, bytes, offset + 4);
			bitconverter.GetBytes(msg.best_score, bytes, offset + 8);
			bitconverter.GetBytes(msg.best_lat, bytes, offset + 12);
			bitconverter.GetBytes(msg.best_lon, bytes, offset + 16);
			bitconverter.GetBytes(msg.best_alt, bytes, offset + 20);
			bitconverter.GetBytes(msg.best_detection_id, bytes, offset + 24);
			bitconverter.GetBytes(msg.best_cluster_id, bytes, offset + 28);
			bitconverter.GetBytes(msg.best_cluster_iter_id, bytes, offset + 32);
			bitconverter.GetBytes(msg.images_done, bytes, offset + 36);
			bitconverter.GetBytes(msg.images_todo, bytes, offset + 40);
			bitconverter.GetBytes(msg.fps, bytes, offset + 44);
			offset += 48;
			return 205;
		}

		internal static int Serialize_ONBOARD_HEALTH(this Msg_onboard_health msg, byte[] bytes, ref int offset)
		{
			bitconverter.GetBytes(msg.uptime, bytes, offset + 0);
			bitconverter.GetBytes(msg.ram_total, bytes, offset + 4);
			bitconverter.GetBytes(msg.swap_total, bytes, offset + 8);
			bitconverter.GetBytes(msg.disk_total, bytes, offset + 12);
			bitconverter.GetBytes(msg.temp, bytes, offset + 16);
			bitconverter.GetBytes(msg.voltage, bytes, offset + 20);
			bitconverter.GetBytes(msg.network_load_in, bytes, offset + 24);
			bitconverter.GetBytes(msg.network_load_out, bytes, offset + 28);
			bitconverter.GetBytes(msg.cpu_freq, bytes, offset + 32);
			bytes[offset + 34] = msg.cpu_load;
			bytes[offset + 35] = msg.ram_usage;
			bytes[offset + 36] = msg.swap_usage;
			bytes[offset + 37] = unchecked((byte)msg.disk_health);
			bytes[offset + 38] = msg.disk_usage;
			offset += 39;
			return 206;
		}
